{
  ...
  "main": {
    ...
    "menu": {
      "style": "font-family: 'Arial'; font: bold; font-size: 14px; background-color: #e5000f;border:2px solid #c20f00",
      "loc": [
        3,
        6
      ]
    ...
    "menubar": {
      "style": "font-family: 'Arial'; font:bold; font-size: 14px;"
    },
    "close": {
      "image": "$path/x.png",
      "loc": [
    ...
    "defaultwindow": {
      "style": "background: #e5000f; font-family:'Arial';font:bold;selection-background-color:#919191; "
    },
    "chums": {
      "style": "border:2px solid #ffa4a4; background-color: black;color: white;font: bold;font-size:14px;font-family: 'Arial';selection-background-color:#646464; ",
      "moods": {
        "chummy": {
    ...
    "mychumhandle": {
      ...
      "handle": {
        "style": "background-color: black; padding: 3px; padding-left: 25px; color:white; font-family:'Arial'; font:bold; text-align:left; border:2px solid #ffa4a4;"
      }
    },
    "addchum": {
      "text": "ADD CHUMP",
      "style": "background: #ffa4a4; border:2px solid #780000; font: bold; color: black; font-family:'Arial';"
    },
    "pester": {
      "text": "TROLL",
      "style": "background: #ffa4a4; border:2px solid #780000; font: bold; color: black; font-family:'Arial';"
    ...
    "moodlabel": {
      "style": "font:bold;font-family:'Arial';color:black;"
    },
    "defaultmood": 7,
    "moods": [
      {
