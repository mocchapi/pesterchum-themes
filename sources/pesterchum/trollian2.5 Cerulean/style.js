{"inherits": "pesterchum2.5",
 ...
 {"background-image": "$path/tnbg.png",
  ...
  "menu" : { "style": "font-family: 'Arial'; font: bold; font-size: 14px; background-color: #0F3860;border:2px solid #0C1855", "loc": [3, 6] },
  ...
  "defaultwindow": { "style": "background: #0F3860; font-family:'Arial';font:bold;selection-background-color:#919191; " },
  "chums": { "style": "border:2px solid #98B3FF; background-color: black;color: white;font: bold;font-size:14px;font-family: 'Arial';selection-background-color:#646464; ",
             "moods": { 

                 "chummy": { "icon": "$path/chummy.png", "color": "#98B3FF" },

                 "rancorous": { "icon": "$path/rancorous.png", "color": "#004182" },
                 ...
                 "ecstatic": { "icon": "$path/ecstatic.png", "color": "#004182" },

                 "relaxed": { "icon": "$path/relaxed.png", "color": "#004182" },

                 "discontent": { "icon": "$path/discontent.png", "color": "#004182" },

                 "devious": { "icon": "$path/devious.png", "color": "#004182" },

                 "sleek": { "icon": "$path/sleek.png", "color": "#004182" },
			     
                 "detestful": { "icon": "$path/detestful.png", "color": "#004182" },

                 "mirthful": { "icon": "$path/mirthful.png", "color": "#004182" },

                 "manipulative": { "icon": "$path/manipulative.png", "color": "#004182" },

                 "vigorous": { "icon": "$path/vigorous.png", "color": "#004182" },

                 "perky": { "icon": "$path/perky.png", "color": "#004182" },

                 "acceptant": { "icon": "$path/acceptant.png", "color": "#004182" },

                 "protective": { "icon": "$path/protective.png", "color": "#0080FF" },
 ...
 "convo": {
     "style": "background-color: #0F3860;border:2px solid #0C1855; font-family: 'Arial';",
  ...
  "input": { "style": "background: white; border:2px solid #ffa4a4;margin-top:5px; margin-right:10px; margin-left:10px; font-size: 12px;" },
	 "tabwindow" : {
		 "style": "background-color: #0F3860;border:2px solid #0C1855;"
	 },
  "text": {
 ...
 "memos":
 { "size": [600,425],
   "style": "background-color: #0F3860;border:2px solid #0C1855; font-family: 'Courier';",
   ...
   "time": { "text": { "style": " border: 2px solid #0C1855; background: white; font-size: 12px; margin-top: 5px; margin-right: 5px; margin-left: 5px; font-family:'Arial';font:bold;" 
             ...
             "buttons": { "style": "color: black; font: bold; border: 2px solid #0C1855; font: bold; font-size: 12px; background: #0F3860; margin-top: 5px; margin-right: 5px; margin-left: 5px; padding: 2px; width: 50px;" }
          },
