{"main":
 {"style": "",
  ...
  "sounds": { "alertsound": "$path/DING.WAV",
                          "memosound": "$path/DING.WAV",
                          "ceasesound": "$path/CHIMES.WAV" },
   "menus": {"client": {"_name": "            ",
                       "options": "Options",
  ...
  "trollslum": {
    ...
    "addchum":  { "style": "background: transparent url($path/addchum.png); border:0px solid dicks;",
                "loc": [16,453],
                "size": [90, 44]
              },
  "pester": { "style": "background: transparent url($path/messagechum.png); border:0px solid dicks;",
              "loc": [106,453],
              "size": [90, 44]
            },
  "block": { "style": "background: transparent url($path/blockchum.png); border:0px solid dicks;",
             "loc": [196,453],
             "size": [90, 44]
           },
  "defaultmood": 7,
  ...
  "moods": [
      { "style": "text-align:left; background:#c3c3c3; color: #000000; font-family:'arial'; font-size:11px;  padding-left:3px;",
                "selected": "text-align:left; background: #314159; color: #000000; font-family:'arial'; font-size:11px;  padding-left:2px;",
                "loc": [18, 535],
                "size": [90, 22],
             "text": "Ecstatic",
      ...
      { "style": "text-align:left; background:#c3c3c3; color: #000000; font-family:'arial'; font-size:11px;  padding-left:3px;",
                "selected": "text-align:left; background: #314159; color: #000000; font-family:'arial'; font-size:11px;  padding-left:3px;",
                "loc": [18, 557],
                "size": [90, 22],
            "text": "Relaxed",
      ...
      { "style": "text-align:left; background:#c3c3c3; color: #000000; font-family:'arial'; font-size:11px; font-size:11px;  padding-left:3px;",
                "selected": "text-align:left; background: #314159; color: #000000; font-family:'arial'; font-size:11px; font-size:11px;  padding-left:3px;",
                "loc": [108, 579],
                "size": [90, 22],
             "text": "Detestful",
      ...
      { "style": "text-align:left; font-size:11px; background:#c3c3c3; color: #000000; font-family:'arial';  padding-left:3px;",
                "selected": "text-align:left; background: #314159; color: #000000; font-family:'arial'; font-size:11px;  padding-left:3px;",
                "loc": [198, 557],
                "size": [90, 22],
            "text": "Acceptant",
 ...
 "memoicon": "$path/trayicon.png",
  ...
  "label": { "text": "Welcome to $channel!",
             "style": "margin-bottom: 21px;background: #AD0000; color: #FFFFFF; border:0px; font-size: 14px;",
 ...
 "toasts":
 {
   ...
   "icon": { "signin": "$path/ecstatic2.gif",
             "signout": "$path/discontent2.gif",
